...
const LoginPage = () => {
  ...
  return (
    <div className="container-fluid min-vh-100 d-flex justify-content-center align-items-center bg-light">
      {/* removi apenas as classes flex do card, pois o grid assumirá o layout */}
      <div className="card shadow w-100 mx-auto" style={{ maxWidth: '850px' }}>
        {/* NOVO: grid correto do Bootstrap */}
        <div className="row g-0">
          {/* Coluna do formulário (mantidos p-5 e demais classes) */}
          ...
          {/* Coluna da imagem/azul (mantidas classes e estilos originais) */}
